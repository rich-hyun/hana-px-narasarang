const HANA_PX_DATA = {
  ...
  questions: [
    ...
    {
      id: "q5",
      text: "하나원큐 앱을 쓴다면 가장 자주 확인할 것 같은 기능은?",
      choices: [
    ...
    {
      id: "q7",
      text: "경기장 부스에서 가장 해보고 싶은 미션은?",
      choices: [
        { text: "내 혜택 유형 테스트", scores: { digital: 2, px: 1 }, benefits: ["digital_life"] },
        { text: "PX 콘셉트 포토존", scores: { culture: 2 }, benefits: ["sports_event"] },
        { text: "혜택 퀴즈 맞히기", scores: { saving: 2 }, benefits: ["salary_management"] },
        { text: "즉석 이벤트 참여", scores: { culture: 2, food: 1 }, benefits: ["sports_event", "movie_culture"] }
      ]
    },
    {
      id: "q8",
    ...
    },
    {
      ...
      choices: [
        ...
        { text: "먹고 노는 데 도움 되는 카드", scores: { food: 2, culture: 1 }, benefits: ["delivery_food", "sports_event"] },
